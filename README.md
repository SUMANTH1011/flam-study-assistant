...
Once the data is validated, it is stored in React state and passed to:
...
is valid JSON but does not contain flashcards.
...
and accessed by the Node.js backend.

The frontend never contains:

GEMINI_API_KEY

and never calls Gemini directly.
